module.exports = {
  ...
  rules: {
    ...
    "no-undef": ["error"], // 禁用未声明的变量，除非它们在 /*global */ 注释中被提到（https://github.com/eslint/eslint/blob/master/docs/rules/no-undef.md）
    ...
    "line-comment-position": ["off", { "position": "above", "ignorePattern": "ETC" }], // 强制行注释的位置
    ...
    "object-shorthand": ["off", "always"], // 不强制要求或禁止对象字面量中方法和属性使用简写语法
